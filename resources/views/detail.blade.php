                        ...
                        <div class="col-sm-10 order-1 order-sm-2">
                            <div class="owl-carousel product-slider" data-slider-id="1"><a class="d-block"
                                    href="/img/product-detail-1.jpg" data-lightbox="product" title="Product item 1"><img
                                        class="img-fluid" src="/img/product-detail-1.jpg" alt="..."></a><a class="d-block"
                                    href="/img/product-detail-2.jpg" data-lightbox="product" title="Product item 2"><img
                                        class="img-fluid" src="/img/product-detail-2.jpg" alt="..."></a><a class="d-block"
                                    href="/img/product-detail-3.jpg" data-lightbox="product" title="Product item 3"><img
                                        class="img-fluid" src="/img/product-detail-3.jpg" alt="..."></a><a class="d-block"
            ...
            <div class="tab-content mb-5" id="myTabContent">
                ...
                <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                    <div class="p-4 p-lg-5 bg-white">
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="media mb-3"><img class="rounded-circle" src="/img/customer-1.png" alt=""
                                        width="50">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="product text-center skel-loader">
                        <div class="d-block mb-3 position-relative"><a class="d-block" href="/detail"><img
